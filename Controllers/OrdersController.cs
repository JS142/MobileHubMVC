...
using MobileHubMVC.Data;
using MobileHubMVC.Models;

namespace MobileHubMVC.Controllers
{
    [Authorize]
    public class OrdersController : Controller
    {
        ...
        public OrdersController(MobileDbContext context)
        {
            _context = context;
        }
        ...
        {
            var mobileDbContext = _context.Order.Include(o => o.Mobilem).Include(o => o.User);
            return View(await mobileDbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,UserID,MobileID,OrderDate")] Order order)
        {
